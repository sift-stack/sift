        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "IGNORE_IF_UNPOPULATED" => Ok(Ignore::IfUnpopulated),
                    "IGNORE_IF_DEFAULT_VALUE" => Ok(Ignore::IfDefaultValue),
...
impl serde::Serialize for PredefinedConstraints {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("buf.validate.PredefinedConstraints", len)?;
        if !self.cel.is_empty() {
            struct_ser.serialize_field("cel", &self.cel)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for PredefinedConstraints {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PredefinedConstraints;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct buf.validate.PredefinedConstraints")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PredefinedConstraints, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut cel__ = None;
                ...
                Ok(PredefinedConstraints {
                    cel: cel__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("buf.validate.PredefinedConstraints", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Violation {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.constraint_id.as_ref() {
            struct_ser.serialize_field("constraintId", v)?;
        }
        if let Some(v) = self.message.as_ref() {
            struct_ser.serialize_field("message", v)?;
        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ConstraintId => {
                            ...
                            constraint_id__ = map_.next_value()?;
                        }
                        GeneratedField::Message => {
                            if message__.is_some() {
                                return Err(serde::de::Error::duplicate_field("message"));
