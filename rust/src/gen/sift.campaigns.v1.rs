...
pub struct Campaign {
    ...
    #[prost(string, tag="13")]
    pub created_from_campaign_id: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Initializer {
        ...
        #[prost(message, tag="1")]
        ReportIds(super::super::super::common::r#type::v1::ResourceIdentifiers),
        /// Create a campaign from a set of runs by collecting all the reports generated by those runs
        #[prost(message, tag="2")]
        RunIds(super::super::super::common::r#type::v1::ResourceIdentifiers),
        /// Duplicate another campaign
        #[prost(message, tag="3")]
        CampaignId(super::super::super::common::r#type::v1::ResourceIdentifier),
    }
}
