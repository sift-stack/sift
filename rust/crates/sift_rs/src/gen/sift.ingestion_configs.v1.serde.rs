...
impl serde::Serialize for ChannelConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.ChannelConfig", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ChannelConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.ChannelConfig")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.ChannelConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateIngestionConfigFlowsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigFlowsRequest", len)?;
        if !self.ingestion_config_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateIngestionConfigFlowsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.CreateIngestionConfigFlowsRequest")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigFlowsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateIngestionConfigFlowsResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigFlowsResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CreateIngestionConfigFlowsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.CreateIngestionConfigFlowsResponse")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigFlowsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateIngestionConfigRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigRequest", len)?;
        if !self.asset_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateIngestionConfigRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.CreateIngestionConfigRequest")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateIngestionConfigResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateIngestionConfigResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.CreateIngestionConfigResponse")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.CreateIngestionConfigResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FlowConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.FlowConfig", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.channels.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FlowConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.FlowConfig")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.FlowConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetIngestionConfigRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.GetIngestionConfigRequest", len)?;
        if !self.ingestion_config_id.is_empty() {
            struct_ser.serialize_field("ingestionConfigId", &self.ingestion_config_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetIngestionConfigRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.GetIngestionConfigRequest")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.GetIngestionConfigRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetIngestionConfigResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.GetIngestionConfigResponse", len)?;
        if let Some(v) = self.ingestion_config.as_ref() {
            struct_ser.serialize_field("ingestionConfig", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetIngestionConfigResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.GetIngestionConfigResponse")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.GetIngestionConfigResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IngestionConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.IngestionConfig", len)?;
        if !self.ingestion_config_id.is_empty() {
            struct_ser.serialize_field("ingestionConfigId", &self.ingestion_config_id)?;
        }
        if !self.asset_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for IngestionConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.IngestionConfig")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.IngestionConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListIngestionConfigFlowsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.ListIngestionConfigFlowsRequest", len)?;
        if !self.ingestion_config_id.is_empty() {
            struct_ser.serialize_field("ingestionConfigId", &self.ingestion_config_id)?;
        }
        if self.page_size != 0 {
...
impl<'de> serde::Deserialize<'de> for ListIngestionConfigFlowsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.ListIngestionConfigFlowsRequest")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.ListIngestionConfigFlowsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListIngestionConfigFlowsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.ListIngestionConfigFlowsResponse", len)?;
        if !self.flows.is_empty() {
            struct_ser.serialize_field("flows", &self.flows)?;
        }
        if !self.next_page_token.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListIngestionConfigFlowsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.ListIngestionConfigFlowsResponse")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.ListIngestionConfigFlowsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListIngestionConfigsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.ListIngestionConfigsRequest", len)?;
        if self.page_size != 0 {
            struct_ser.serialize_field("pageSize", &self.page_size)?;
        }
        if !self.page_token.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListIngestionConfigsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.ListIngestionConfigsRequest")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.ListIngestionConfigsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListIngestionConfigsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.ingestion_configs.v1.ListIngestionConfigsResponse", len)?;
        if !self.ingestion_configs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListIngestionConfigsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.ingestion_configs.v1.ListIngestionConfigsResponse")
            }
        ...
        deserializer.deserialize_struct("sift.ingestion_configs.v1.ListIngestionConfigsResponse", FIELDS, GeneratedVisitor)
    }
}
