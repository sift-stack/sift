...
impl serde::Serialize for CalculatedChannelDependency {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.common.r#type.v1.CalculatedChannelDependency", len)?;
        if !self.calculated_channel_version_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CalculatedChannelDependency {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.common.r#type.v1.CalculatedChannelDependency")
            }
        ...
        deserializer.deserialize_struct("sift.common.r#type.v1.CalculatedChannelDependency", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Organization {
        ...
        S: serde::Serializer,
    {
        ...
        if self.is_abac_enabled.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.is_abac_enabled.as_ref() {
            struct_ser.serialize_field("isAbacEnabled", v)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "isAbacEnabled" | "is_abac_enabled" => Ok(GeneratedField::IsAbacEnabled),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut is_abac_enabled__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::OrganizationId => {
                            if organization_id__.is_some() {
                        ...
                        GeneratedField::IsAbacEnabled => {
                            if is_abac_enabled__.is_some() {
                                return Err(serde::de::Error::duplicate_field("isAbacEnabled"));
                            }
                            is_abac_enabled__ = map_.next_value()?;
                        }
                    }
                }
                Ok(Organization {
                    ...
                    is_abac_enabled: is_abac_enabled__,
                })
            }
        }
