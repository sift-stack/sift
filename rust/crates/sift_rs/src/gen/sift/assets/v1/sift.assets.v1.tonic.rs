...
pub mod asset_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_asset(
            ...
            tonic::Response<super::CreateAssetResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.assets.v1.AssetService", "CreateAsset"));
            self.inner.unary(req, path, codec).await
        }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sift.assets.v1.AssetService/CreateAsset" => {
                    #[allow(non_camel_case_types)]
                    struct CreateAssetSvc<T: AssetService>(pub Arc<T>);
                    impl<
                        T: AssetService,
                    > tonic::server::UnaryService<super::CreateAssetRequest>
                    for CreateAssetSvc<T> {
                        type Response = super::CreateAssetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AssetService>::create_asset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
