...
pub mod tag_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.tags.v2.TagService", "CreateTag"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.tags.v2.TagService", "ListTags"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod tag_service_server {
    ...
    pub const SERVICE_NAME: &str = "sift.tags.v2.TagService";
