...
pub mod channel_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.channels.v3.ChannelService", "GetChannel"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.channels.v3.ChannelService", "ListChannels"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.channels.v3.ChannelService", "UpdateChannel"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod channel_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sift.channels.v3.ChannelService/ListChannels" => {
                    #[allow(non_camel_case_types)]
                    struct ListChannelsSvc<T: ChannelService>(pub Arc<T>);
                    impl<
                        T: ChannelService,
                    ...
                    for ListChannelsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChannelService>::list_channels(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "sift.channels.v3.ChannelService";
