...
pub mod channel_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.channels.v2.ChannelService", "GetChannel"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.channels.v2.ChannelService", "ListChannels"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod channel_service_server {
    ...
    pub const SERVICE_NAME: &str = "sift.channels.v2.ChannelService";
