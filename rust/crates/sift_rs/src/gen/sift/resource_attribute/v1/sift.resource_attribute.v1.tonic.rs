...
pub mod resource_attribute_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn check_resource_attribute_key_archive_impact(
            &mut self,
            request: impl tonic::IntoRequest<
                super::CheckResourceAttributeKeyArchiveImpactRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::CheckResourceAttributeKeyArchiveImpactResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sift.resource_attribute.v1.ResourceAttributeService/CheckResourceAttributeKeyArchiveImpact",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn batch_list_resource_attributes_by_entity(
            &mut self,
            request: impl tonic::IntoRequest<
                super::BatchListResourceAttributesByEntityRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::BatchListResourceAttributesByEntityResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sift.resource_attribute.v1.ResourceAttributeService/BatchListResourceAttributesByEntity",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sift.resource_attribute.v1.ResourceAttributeService",
                        "BatchListResourceAttributesByEntity",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod resource_attribute_service_server {
    ...
    #[async_trait]
    pub trait ResourceAttributeService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn update_resource_attribute_key(
            ...
            tonic::Status,
        >;
        async fn check_resource_attribute_key_archive_impact(
            &self,
            request: tonic::Request<super::CheckResourceAttributeKeyArchiveImpactRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CheckResourceAttributeKeyArchiveImpactResponse>,
            tonic::Status,
        >;
        ...
        async fn list_resource_attributes_by_entity(
            ...
            tonic::Status,
        >;
        async fn batch_list_resource_attributes_by_entity(
            &self,
            request: tonic::Request<super::BatchListResourceAttributesByEntityRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchListResourceAttributesByEntityResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct ResourceAttributeServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> ResourceAttributeServiceServer<T> {
        pub fn new(inner: T) -> Self {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sift.resource_attribute.v1.ResourceAttributeService/CheckResourceAttributeKeyArchiveImpact" => {
                    #[allow(non_camel_case_types)]
                    struct CheckResourceAttributeKeyArchiveImpactSvc<
                        T: ResourceAttributeService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::CheckResourceAttributeKeyArchiveImpactRequest,
                    > for CheckResourceAttributeKeyArchiveImpactSvc<T> {
                        type Response = super::CheckResourceAttributeKeyArchiveImpactResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ResourceAttributeService>::check_resource_attribute_key_archive_impact(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CheckResourceAttributeKeyArchiveImpactSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/sift.resource_attribute.v1.ResourceAttributeService/BatchListResourceAttributesByEntity" => {
                    #[allow(non_camel_case_types)]
                    struct BatchListResourceAttributesByEntitySvc<
                        T: ResourceAttributeService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::BatchListResourceAttributesByEntityRequest,
                    > for BatchListResourceAttributesByEntitySvc<T> {
                        type Response = super::BatchListResourceAttributesByEntityResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ResourceAttributeService>::batch_list_resource_attributes_by_entity(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchListResourceAttributesByEntitySvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ResourceAttributeServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "sift.resource_attribute.v1.ResourceAttributeService";
    impl<T> tonic::server::NamedService for ResourceAttributeServiceServer<T> {
