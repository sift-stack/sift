        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.value.as_ref() {
            match v {
                ...
                batch_create_resource_attributes_request::Value::ResourceAttributeEnumValueIds(v) => {
                    struct_ser.serialize_field("resourceAttributeEnumValueIds", v)?;
                }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ResourceAttributeEnumValueIds => {
                            ...
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(batch_create_resource_attributes_request::Value::ResourceAttributeEnumValueIds)
;
                        }
...
impl serde::Serialize for BatchListResourceAttributesByEntityRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityRequest", len)?;
        if !self.entities.is_empty() {
            struct_ser.serialize_field("entities", &self.entities)?;
        }
        if self.include_archived {
...
impl<'de> serde::Deserialize<'de> for BatchListResourceAttributesByEntityRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = BatchListResourceAttributesByEntityRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.BatchListResourceAttributesByEntityRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BatchListResourceAttributesByEntityRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut entities__ = None;
                ...
                Ok(BatchListResourceAttributesByEntityRequest {
                    entities: entities__.unwrap_or_default(),
                    include_archived: include_archived__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BatchListResourceAttributesByEntityResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse", len)?;
        if !self.results.is_empty() {
...
impl<'de> serde::Deserialize<'de> for BatchListResourceAttributesByEntityResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = BatchListResourceAttributesByEntityResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BatchListResourceAttributesByEntityResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(BatchListResourceAttributesByEntityResponse {
                    results: results__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for batch_list_resource_attributes_by_entity_response::EntityResourceAttributes {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse.EntityResourceAttributes", len)?;
...
impl<'de> serde::Deserialize<'de> for batch_list_resource_attributes_by_entity_response::EntityResourceAttributes {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = batch_list_resource_attributes_by_entity_response::EntityResourceAttributes;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse.EntityResourceAttributes")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<batch_list_resource_attributes_by_entity_response::EntityResourceAttributes, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(batch_list_resource_attributes_by_entity_response::EntityResourceAttributes {
                    entity: entity__,
                    resource_attributes: resource_attributes__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.BatchListResourceAttributesByEntityResponse.EntityResourceAttributes", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for CheckResourceAttributeKeyArchiveImpactRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactRequest", len)?;
        if !self.resource_attribute_key_id.is_empty() {
            struct_ser.serialize_field("resourceAttributeKeyId", &self.resource_attribute_key_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CheckResourceAttributeKeyArchiveImpactRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CheckResourceAttributeKeyArchiveImpactRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CheckResourceAttributeKeyArchiveImpactRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut resource_attribute_key_id__ = None;
                ...
                Ok(CheckResourceAttributeKeyArchiveImpactRequest {
                    resource_attribute_key_id: resource_attribute_key_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CheckResourceAttributeKeyArchiveImpactResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.active_resource_attribute_assignment_count != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactResponse", len)?;
        if self.active_resource_attribute_assignment_count != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("activeResourceAttributeAssignmentCount", ToString::to_string(&self.active_resource_attribute_assignment_count).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CheckResourceAttributeKeyArchiveImpactResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            "active_resource_attribute_assignment_count",
            "activeResourceAttributeAssignmentCount",
        ];
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "activeResourceAttributeAssignmentCount" | "active_resource_attribute_assignment_count" => Ok(GeneratedField::ActiveResourceAttributeAssignmentCount),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CheckResourceAttributeKeyArchiveImpactResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CheckResourceAttributeKeyArchiveImpactResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut active_resource_attribute_assignment_count__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ActiveResourceAttributeAssignmentCount => {
                            if active_resource_attribute_assignment_count__.is_some() {
                                return Err(serde::de::Error::duplicate_field("activeResourceAttributeAssignmentCount"));
                            }
                            active_resource_attribute_assignment_count__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                }
                Ok(CheckResourceAttributeKeyArchiveImpactResponse {
                    active_resource_attribute_assignment_count: active_resource_attribute_assignment_count__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.CheckResourceAttributeKeyArchiveImpactResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ResourceAttributeEntityType {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::Run => "RESOURCE_ATTRIBUTE_ENTITY_TYPE_RUN",
        };
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "RESOURCE_ATTRIBUTE_ENTITY_TYPE_RUN" => Ok(ResourceAttributeEntityType::Run),
...
impl serde::Serialize for ResourceAttributeEnumValueIdList {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.resource_attribute.v1.ResourceAttributeEnumValueIdList", len)?;
        if !self.ids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResourceAttributeEnumValueIdList {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ResourceAttributeEnumValueIdList;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.resource_attribute.v1.ResourceAttributeEnumValueIdList")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ResourceAttributeEnumValueIdList, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ids__ = None;
                ...
                Ok(ResourceAttributeEnumValueIdList {
                    ids: ids__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.resource_attribute.v1.ResourceAttributeEnumValueIdList", FIELDS, GeneratedVisitor)
    }
}
