...
pub mod data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.data.v2.DataService", "GetData"));
...
pub mod data_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sift.data.v2.DataService/GetData" => {
                    ...
                    struct GetDataSvc<T: DataService>(pub Arc<T>);
                    impl<
                        T: DataService,
                    ...
                    for GetDataSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DataService>::get_data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "sift.data.v2.DataService";
