        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sift.notifications.v1.NotificationService",
                        "ListNotifications",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn batch_update_notifications(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchUpdateNotificationsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchUpdateNotificationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod notification_service_server {
    ...
    pub trait NotificationService: std::marker::Send + std::marker::Sync + 'static {
        async fn list_notifications(
            ...
            tonic::Status,
        >;
        async fn batch_update_notifications(
            &self,
            request: tonic::Request<super::BatchUpdateNotificationsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchUpdateNotificationsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sift.notifications.v1.NotificationService/BatchUpdateNotifications" => {
                    #[allow(non_camel_case_types)]
                    struct BatchUpdateNotificationsSvc<T: NotificationService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: NotificationService,
                    > tonic::server::UnaryService<super::BatchUpdateNotificationsRequest>
                    for BatchUpdateNotificationsSvc<T> {
                        type Response = super::BatchUpdateNotificationsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::BatchUpdateNotificationsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotificationService>::batch_update_notifications(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchUpdateNotificationsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "sift.notifications.v1.NotificationService";
