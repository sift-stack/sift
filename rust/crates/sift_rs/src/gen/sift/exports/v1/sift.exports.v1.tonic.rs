...
pub mod export_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.exports.v1.ExportService", "ExportData"));
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.exports.v1.ExportService", "GetDownloadUrl"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod export_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sift.exports.v1.ExportService/ExportData" => {
                    ...
                    struct ExportDataSvc<T: ExportService>(pub Arc<T>);
                    impl<
                        T: ExportService,
                    > tonic::server::UnaryService<super::ExportDataRequest>
                    for ExportDataSvc<T> {
                        type Response = super::ExportDataResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ExportService>::export_data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sift.exports.v1.ExportService/GetDownloadUrl" => {
                    #[allow(non_camel_case_types)]
                    struct GetDownloadUrlSvc<T: ExportService>(pub Arc<T>);
                    impl<
                        T: ExportService,
                    ...
                    for GetDownloadUrlSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ExportService>::get_download_url(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "sift.exports.v1.ExportService";
