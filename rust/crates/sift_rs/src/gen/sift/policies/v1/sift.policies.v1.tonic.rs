...
pub mod policy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.policies.v1.PolicyService", "GetPolicy"));
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "ListPolicies"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "CreatePolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "UpdatePolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sift.policies.v1.PolicyService/ValidatePolicy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "ValidatePolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn archive_policy(
            &mut self,
            request: impl tonic::IntoRequest<super::ArchivePolicyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ArchivePolicyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "ArchivePolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn unarchive_policy(
            &mut self,
            request: impl tonic::IntoRequest<super::UnarchivePolicyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnarchivePolicyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sift.policies.v1.PolicyService/UnarchivePolicy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.policies.v1.PolicyService", "UnarchivePolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod policy_service_server {
    ...
    pub trait PolicyService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn archive_policy(
            &self,
            request: tonic::Request<super::ArchivePolicyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ArchivePolicyResponse>,
            tonic::Status,
        >;
        async fn unarchive_policy(
            &self,
            request: tonic::Request<super::UnarchivePolicyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnarchivePolicyResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sift.policies.v1.PolicyService/ValidatePolicy" => {
                    #[allow(non_camel_case_types)]
                    struct ValidatePolicySvc<T: PolicyService>(pub Arc<T>);
                    impl<
                        T: PolicyService,
                    ...
                    for ValidatePolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyService>::validate_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sift.policies.v1.PolicyService/ArchivePolicy" => {
                    #[allow(non_camel_case_types)]
                    struct ArchivePolicySvc<T: PolicyService>(pub Arc<T>);
                    impl<
                        T: PolicyService,
                    > tonic::server::UnaryService<super::ArchivePolicyRequest>
                    for ArchivePolicySvc<T> {
                        type Response = super::ArchivePolicyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyService>::archive_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ArchivePolicySvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/sift.policies.v1.PolicyService/UnarchivePolicy" => {
                    #[allow(non_camel_case_types)]
                    struct UnarchivePolicySvc<T: PolicyService>(pub Arc<T>);
                    impl<
                        T: PolicyService,
                    > tonic::server::UnaryService<super::UnarchivePolicyRequest>
                    for UnarchivePolicySvc<T> {
                        type Response = super::UnarchivePolicyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyService>::unarchive_policy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UnarchivePolicySvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "sift.policies.v1.PolicyService";
