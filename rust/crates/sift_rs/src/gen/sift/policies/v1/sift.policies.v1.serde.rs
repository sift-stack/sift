...
impl serde::Serialize for UnarchivePolicyRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.policies.v1.UnarchivePolicyRequest", len)?;
        if !self.policy_id.is_empty() {
            struct_ser.serialize_field("policyId", &self.policy_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for UnarchivePolicyRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = UnarchivePolicyRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.policies.v1.UnarchivePolicyRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<UnarchivePolicyRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut policy_id__ = None;
                ...
                Ok(UnarchivePolicyRequest {
                    policy_id: policy_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.policies.v1.UnarchivePolicyRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UnarchivePolicyResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.policies.v1.UnarchivePolicyResponse", len)?;
        if let Some(v) = self.policy.as_ref() {
            struct_ser.serialize_field("policy", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for UnarchivePolicyResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = UnarchivePolicyResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.policies.v1.UnarchivePolicyResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<UnarchivePolicyResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut policy__ = None;
                ...
                Ok(UnarchivePolicyResponse {
                    policy: policy__,
                })
            }
        }
        deserializer.deserialize_struct("sift.policies.v1.UnarchivePolicyResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ValidatePolicyRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.policies.v1.ValidatePolicyRequest", len)?;
        if !self.cedar_policy.is_empty() {
            struct_ser.serialize_field("cedarPolicy", &self.cedar_policy)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ValidatePolicyRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ValidatePolicyRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.policies.v1.ValidatePolicyRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidatePolicyRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut cedar_policy__ = None;
                ...
                Ok(ValidatePolicyRequest {
                    cedar_policy: cedar_policy__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.policies.v1.ValidatePolicyRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatePolicyResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.policies.v1.ValidatePolicyResponse", len)?;
        if self.valid {
            struct_ser.serialize_field("valid", &self.valid)?;
        }
        if let Some(v) = self.failure_message.as_ref() {
            struct_ser.serialize_field("failureMessage", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ValidatePolicyResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "failureMessage" | "failure_message" => Ok(GeneratedField::FailureMessage),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ValidatePolicyResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.policies.v1.ValidatePolicyResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidatePolicyResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut valid__ = None;
                let mut failure_message__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::FailureMessage => {
                            if failure_message__.is_some() {
                                return Err(serde::de::Error::duplicate_field("failureMessage"));
                            }
                            failure_message__ = map_.next_value()?;
                        }
                    }
                }
                Ok(ValidatePolicyResponse {
                    valid: valid__.unwrap_or_default(),
                    failure_message: failure_message__,
                })
            }
        }
        deserializer.deserialize_struct("sift.policies.v1.ValidatePolicyResponse", FIELDS, GeneratedVisitor)
    }
}
