...
pub mod comment_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.comment.v1.CommentService", "CreateComment"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.comment.v1.CommentService", "ListComments"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.comment.v1.CommentService", "UpdateComment"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sift.comment.v1.CommentService", "DeleteComment"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod comment_service_server {
    ...
    pub const SERVICE_NAME: &str = "sift.comment.v1.CommentService";
