...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sift.users.v2.UserService/ListUsers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sift.users.v2.UserService", "ListUsers"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod user_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sift.users.v2.UserService/UpdateUserOrganizationActive" => {
                    ...
                    struct UpdateUserOrganizationActiveSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<
                        super::UpdateUserOrganizationActiveRequest,
                    > for UpdateUserOrganizationActiveSvc<T> {
                        type Response = super::UpdateUserOrganizationActiveResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UserService>::update_user_organization_active(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = UpdateUserOrganizationActiveSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "sift.users.v2.UserService";
