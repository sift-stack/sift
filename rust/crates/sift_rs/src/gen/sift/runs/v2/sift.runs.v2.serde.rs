...
impl serde::Serialize for GetFilterFieldsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("sift.runs.v2.GetFilterFieldsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetFilterFieldsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetFilterFieldsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.runs.v2.GetFilterFieldsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetFilterFieldsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(GetFilterFieldsRequest {
                })
            }
        }
        deserializer.deserialize_struct("sift.runs.v2.GetFilterFieldsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetFilterFieldsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.runs.v2.GetFilterFieldsResponse", len)?;
        if !self.filter_fields.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetFilterFieldsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetFilterFieldsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.runs.v2.GetFilterFieldsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetFilterFieldsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetFilterFieldsResponse {
                    filter_fields: filter_fields__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.runs.v2.GetFilterFieldsResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ValidateRunFilterRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.runs.v2.ValidateRunFilterRequest", len)?;
        if !self.filter.is_empty() {
            struct_ser.serialize_field("filter", &self.filter)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ValidateRunFilterRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ValidateRunFilterRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.runs.v2.ValidateRunFilterRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidateRunFilterRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut filter__ = None;
                ...
                Ok(ValidateRunFilterRequest {
                    filter: filter__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.runs.v2.ValidateRunFilterRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidateRunFilterResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sift.runs.v2.ValidateRunFilterResponse", len)?;
        if !self.error_message.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ValidateRunFilterResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ValidateRunFilterResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sift.runs.v2.ValidateRunFilterResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidateRunFilterResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ValidateRunFilterResponse {
                    error_message: error_message__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("sift.runs.v2.ValidateRunFilterResponse", FIELDS, GeneratedVisitor)
    }
}
