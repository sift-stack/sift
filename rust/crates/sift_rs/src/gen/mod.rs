...
pub mod sift {
    pub mod annotation_logs {
        ...
        pub mod v1 {
            include!("sift.annotation_logs.v1.rs");
    ...
    pub mod annotations {
        ...
        pub mod v1 {
            include!("sift.annotations.v1.rs");
    ...
    pub mod common {
        pub mod r#type {
            ...
            pub mod v1 {
                include!("sift.common.type.v1.rs");
