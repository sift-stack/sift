...
mock! {
    ...
    impl UserDefinedFunctionService for UserDefinedFunctionServiceImpl {
        ...
        async fn get_user_defined_function_version(
            ...
            Response<GetUserDefinedFunctionVersionResponse>,
            Status,
        >;
        async fn get_user_defined_function_versions(
            ...
            Response<GetUserDefinedFunctionVersionsResponse>,
            Status,
        >;
        async fn get_user_defined_function_dependents(
            ...
            Response<GetUserDefinedFunctionDependentsResponse>,
            Status,
        >;
        ...
        async fn validate_user_defined_function(
            ...
            Response<ValidateUserDefinedFunctionResponse>,
            Status,
        >;
        ...
        async fn check_updatable_fields(
            ...
            Response<CheckUpdatableFieldsResponse>,
            Status,
        >;
        ...
        async fn list_user_defined_function_versions(
            ...
            Response<ListUserDefinedFunctionVersionsResponse>,
            Status,
        >;
    }
}
