...
mock! {
    ...
    impl CalculatedChannelService for CalculatedChannelServiceImpl {
        async fn get_calculated_channel(
            ...
            Response<GetCalculatedChannelResponse>,
            Status,
        >;
        async fn create_calculated_channel(
            ...
            Response<CreateCalculatedChannelResponse>,
            Status,
        >;
        async fn list_calculated_channels(
            ...
            Response<ListCalculatedChannelsResponse>,
            Status,
        >;
        async fn update_calculated_channel(
            ...
            Response<UpdateCalculatedChannelResponse>,
            Status,
        >;
        async fn list_calculated_channel_versions(
            ...
            Response<ListCalculatedChannelVersionsResponse>,
            Status,
        >;
        async fn resolve_calculated_channel(
            ...
            Response<ResolveCalculatedChannelResponse>,
            Status,
        >;
        async fn batch_resolve_calculated_channels(
            ...
            Response<BatchResolveCalculatedChannelsResponse>,
            Status,
        >;
        async fn list_resolved_calculated_channels(
            ...
            Response<ListResolvedCalculatedChannelsResponse>,
            Status,
        >;
        async fn get_calculated_channel_versions(
            ...
            Response<GetCalculatedChannelVersionsResponse>,
            Status,
        >;
        async fn get_calculated_channel_dependents(
            ...
            Response<GetCalculatedChannelDependentsResponse>,
            Status,
        >;
    }
}
