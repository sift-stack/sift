...
type ListAnnotationLogsRequest struct {
	...
	// For more information about the fields used for filtering, please refer to [this definition](/api/grpc/protocol-buffers/annotation_logs#annotationlogsearchresult). Optional.
