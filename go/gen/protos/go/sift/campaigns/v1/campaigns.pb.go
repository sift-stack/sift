...
type Campaign struct {
	...
	CreatedFromCampaignId string `protobuf:"bytes,13,opt,name=created_from_campaign_id,json=createdFromCampaignId,proto3" json:"created_from_campaign_id,omitempty"`
}
...
type CreateCampaignFrom struct {
	...
	//
	//	*CreateCampaignFrom_ReportIds
	//	*CreateCampaignFrom_RunIds
	//	*CreateCampaignFrom_CampaignId
...
func (x *CreateCampaignFrom) GetReportIds() *v11.ResourceIdentifiers {
	if x, ok := x.GetInitializer().(*CreateCampaignFrom_ReportIds); ok {
		return x.ReportIds
	}
	return nil
}

func (x *CreateCampaignFrom) GetRunIds() *v11.ResourceIdentifiers {
	if x, ok := x.GetInitializer().(*CreateCampaignFrom_RunIds); ok {
		return x.RunIds
	}
	return nil
}

func (x *CreateCampaignFrom) GetCampaignId() *v11.ResourceIdentifier {
	if x, ok := x.GetInitializer().(*CreateCampaignFrom_CampaignId); ok {
		return x.CampaignId
	}
	return nil
}
...
type CreateCampaignFrom_ReportIds struct {
	// Create a campaign directly from a set of reports
	ReportIds *v11.ResourceIdentifiers `protobuf:"bytes,1,opt,name=report_ids,json=reportIds,proto3,oneof"`
}

type CreateCampaignFrom_RunIds struct {
	// Create a campaign from a set of runs by collecting all the reports generated by those runs
	RunIds *v11.ResourceIdentifiers `protobuf:"bytes,2,opt,name=run_ids,json=runIds,proto3,oneof"`
}

type CreateCampaignFrom_CampaignId struct {
	// Duplicate another campaign
	CampaignId *v11.ResourceIdentifier `protobuf:"bytes,3,opt,name=campaign_id,json=campaignId,proto3,oneof"`
}

func (*CreateCampaignFrom_ReportIds) isCreateCampaignFrom_Initializer() {}

func (*CreateCampaignFrom_RunIds) isCreateCampaignFrom_Initializer() {}

func (*CreateCampaignFrom_CampaignId) isCreateCampaignFrom_Initializer() {}
...
var file_sift_campaigns_v1_campaigns_proto_rawDesc = []byte{
	...
	0x22, 0xa7, 0x05, 0x0a, 0x08, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x12, 0x24, 0x0a,
	0x0b, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x52, 0x0a, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x09, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x17, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x30, 0x0a, 0x12, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	0x5f, 0x62, 0x79, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x42,
	0x79, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x13, 0x6d, 0x6f, 0x64, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x52, 0x10, 0x6d, 0x6f, 0x64, 0x69, 0x66,
	...
	0x6d, 0x70, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x52, 0x0c, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65,
	0x64, 0x44, 0x61, 0x74, 0x65, 0x12, 0x44, 0x0a, 0x0d, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65,
	...
	,
	...
	0x8c, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x52,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x08, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73, 0x69, 0x66, 0x74, 0x2e, 0x63,
	0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x61, 0x6d, 0x70,
	0x61, 0x69, 0x67, 0x6e, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x08, 0x63, 0x61, 0x6d, 0x70, 0x61,
	0x69, 0x67, 0x6e, 0x22, 0xb4, 0x02, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a,
	...
	,
	...
	0x00, 0x52, 0x09, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x73, 0x12, 0x43, 0x0a, 0x07,
	0x72, 0x75, 0x6e, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e,
	...
	0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x48, 0x00, 0x52, 0x06, 0x72, 0x75, 0x6e, 0x49, 0x64,
	0x73, 0x12, 0x4a, 0x0a, 0x0b, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x69, 0x66, 0x74, 0x2e, 0x63, 0x6f,
	...
	0x00, 0x52, 0x0a, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x49, 0x64, 0x42, 0x0d, 0x0a,
	...
	0x2f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x73, 0x42, 0xef, 0x01, 0x0a, 0x15, 0x63,
	...
	,
}
...
var file_sift_campaigns_v1_campaigns_proto_depIdxs = []int32{
	...
	14, // 8: sift.campaigns.v1.CreateCampaignFrom.report_ids:type_name -> sift.common.type.v1.ResourceIdentifiers
	14, // 9: sift.campaigns.v1.CreateCampaignFrom.run_ids:type_name -> sift.common.type.v1.ResourceIdentifiers
	15, // 10: sift.campaigns.v1.CreateCampaignFrom.campaign_id:type_name -> sift.common.type.v1.ResourceIdentifier
...
func file_sift_campaigns_v1_campaigns_proto_init() {
	...
	file_sift_campaigns_v1_campaigns_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*CreateCampaignFrom_ReportIds)(nil),
		(*CreateCampaignFrom_RunIds)(nil),
		(*CreateCampaignFrom_CampaignId)(nil),
	}
	type x struct{}
