...
class CreateChannelSchemaRequest(betterproto2.Message):
    ...
    component: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    The name of the component (case-insensitive).
    """

    channel: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    The name of the channel (case-insensitive).
    """

    unit: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    ...
    asset_name: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
...
default_message_pool.register_message(
    "sift.channel_schemas.v1", "CreateChannelSchemaRequest", CreateChannelSchemaRequest
)
