...
default_message_pool.register_message("sift.channels.v2", "Channel", Channel)
...
default_message_pool.register_message(
    "sift.channels.v2", "GetChannelRequest", GetChannelRequest
)
...
default_message_pool.register_message(
    "sift.channels.v2", "GetChannelResponse", GetChannelResponse
)
...
default_message_pool.register_message(
    "sift.channels.v2", "ListChannelsRequest", ListChannelsRequest
)
...
default_message_pool.register_message(
    "sift.channels.v2", "ListChannelsResponse", ListChannelsResponse
)
