...
class View(betterproto.Message):
    ...
    modified_by_user_id: str = betterproto.string_field(9)
    is_pinned: bool = betterproto.bool_field(10)
...
class ViewChannel(betterproto.Message):
    ...
    axis_group: str = betterproto.string_field(4)
    bit_field_names: List[str] = betterproto.string_field(5)
...
class ViewChannelCalculatedChannelConfig(betterproto.Message):
    ...
    channel_references: Dict[
        str, "ViewChannelCalculatedChannelConfigChannelReference"
...
@dataclass(eq=False, repr=False)
class ViewChannelCalculatedChannelConfigChannelReference(betterproto.Message):
    name: str = betterproto.string_field(1)
    component: str = betterproto.string_field(2)
