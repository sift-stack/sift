...
class Channel(betterproto.Message):
    ...
    unit_id: str = betterproto.string_field(5)
    created_date: datetime = betterproto.message_field(6)
    modified_date: datetime = betterproto.message_field(7)
    created_by_user_id: str = betterproto.string_field(8)
    modified_by_user_id: str = betterproto.string_field(9)
    data_type: "__common_type_v1__.ChannelDataType" = betterproto.enum_field(10)
