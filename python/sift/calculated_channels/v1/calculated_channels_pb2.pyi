...
class ExpressionIdentifier(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., type: _Optional[_Union[ExpressionIdentifierType, str]] = ...) -> None: ...

class ValidateExpressionRequest(_message.Message):
    __slots__ = ("expression",)
    EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    expression: ExpressionRequest
    def __init__(self, expression: _Optional[_Union[ExpressionRequest, _Mapping]] = ...) -> None: ...
