...
class Simulator:
    ...
    def run(self):
        ...
        # Buffer size configured to 1 for the purposes of showing data come in live for
        # this low ingestion-rate stream.
        with self.ingestion_service.buffered_ingestion(buffer_size=1) as buffered_ingestion:
