...
class SiftClient(
    ...
    remote_files: RemoteFilesAPI
    """Instance of the Remote Files API for making synchronous requests."""
    ...
    def __init__(
        ...
        self.remote_files = RemoteFilesAPI(self)
        ...
        self.async_ = AsyncAPIs(
            ...
            remote_files=RemoteFilesAPIAsync(self),
