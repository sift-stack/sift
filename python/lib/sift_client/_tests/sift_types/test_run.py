...
class TestRun:
    ...
    async def test_remote_files_property_fetches_files(self, mock_run, mock_client):
        ...
        with patch("sift_client._internal.low_level_wrappers.RemoteFilesLowLevelClient") as mock_low_level_client:
            ...
            assert "ENTITY_TYPE_RUN" in call_kwargs["query_filter"]
