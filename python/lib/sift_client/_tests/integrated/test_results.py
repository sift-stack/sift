...
from sift_client.sift_types import TestMeasurementType, TestStatus, TestStepType
...
async def main():
    ...
    found_report = client.test_results.find_report(custom_filter=f"test_report_id == '{test_report.id_}' && created_date >= timestamp('{create_time}')")
