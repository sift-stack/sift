...
class ReportRuleSummary(BaseType[ReportRuleSummaryProto, "ReportRuleSummary"]):
    ...
    def _to_proto(self) -> ReportRuleSummaryProto:
        """Convert to protobuf message."""
        return ReportRuleSummaryProto(
            rule_id=self.rule_id,
            rule_client_key=self.rule_client_key,
            rule_version_id=self.rule_version_id,
            rule_version_number=self.rule_version_number,
            report_rule_version_id=self.report_rule_version_id,
...
class Report(BaseType[ReportProto, "Report"]):
    ...
    def _to_proto(self) -> ReportProto:
        """Convert to protobuf message."""
        proto = ReportProto(
            ...
            summaries=[summary._to_proto() for summary in self.summaries],
        )
