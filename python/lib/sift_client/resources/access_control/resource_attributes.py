...
class ResourceAttributesAPIAsync(ResourceBase):
    ...
    def __init__(self, sift_client: SiftClient):
        ...
        self.keys = ResourceAttributeKeysAPIAsync(sift_client)
        self.enum_values = ResourceAttributeEnumValuesAPIAsync(sift_client)
        self.assignments = ResourceAttributeAssignmentsAPIAsync(sift_client)


class ResourceAttributeKeysAPIAsync(ResourceBase):
...
class ResourceAttributeEnumValuesAPIAsync(ResourceBase):
...
class ResourceAttributeAssignmentsAPIAsync(ResourceBase):
