...
if TYPE_CHECKING:
    ...
    from sift_client.sift_types.data_import import EXTENSION_TO_DATA_TYPE_KEY, CsvImportConfig, DataTypeKey, Hdf5Schema, ImportConfig, ParquetFlatDatasetImportConfig, ParquetSingleChannelPerRowImportConfig, ParquetTimeColumn
...
class DataImportAPI:
    ...
    def detect_config(self, file_path: str | Path, data_type: DataTypeKey | None = None, hdf5_schema: Hdf5Schema | None = None) -> ImportConfig:
        """
    ...
    def import_from_path(self, file_path: str | Path, *, asset: Asset | str | None = None, config: ImportConfig | None = None, data_type: DataTypeKey | None = None, hdf5_schema: Hdf5Schema | None = None, run: Run | str | None = None, run_name: str | None = None, show_progress: bool | None = None) -> Job:
        """
...
class ReportsAPI:
    ...
    def create_from_rules(self, *, name: str, run: Run | str | None = None, organization_id: str | None = None, rules: list[Rule] | list[str]) -> Job | None:
        """
    ...
    def create_from_template(self, *, report_template_id: str, run_id: str, organization_id: str | None = None, name: str | None = None) -> Job | None:
        """
