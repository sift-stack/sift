...
class TestResultsLowLevelClient(LowLevelClientBase, WithGrpcClient):
    ...
    async def create_test_report(
        ...
        *,
        ...
        if metadata is not None:
            request_kwargs["metadata"] = metadata_dict_to_proto(metadata)

        if serial_number is not None:
            request_kwargs["serial_number"] = serial_number

        if part_number is not None:
            request_kwargs["part_number"] = part_number

        if system_operator is not None:
            request_kwargs["system_operator"] = system_operator
    ...
    async def create_test_step(self, test_step: TestStep) -> TestStep:
    ...
    async def create_test_measurement(self, test_measurement: TestMeasurement) -> TestMeasurement:
        ...
        """
        request = CreateTestMeasurementRequest(test_measurement=test_measurement._to_proto())
    ...
    async def create_test_measurements(
        ...
        """
        measurement_protos = [tm._to_proto() for tm in test_measurements]
