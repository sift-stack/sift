...
class AnnotationsLowLevelClient(LowLevelClientBase, WithGrpcClient):
    ...
    This class provides a thin wrapper around the autogenerated bindings for the
    AnnotationsAPI and the AnnotationLogsAPI.
    """
    ...
    async def list_annotation_logs(
        ...
        *,
        ...
        """List annotation logs with optional filtering and pagination.
    ...
    async def list_all_annotation_logs(
        ...
        *,
        ...
        """List all annotation logs with optional filtering.
