...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.sift.calculated_channels.v2B\027CalculatedChannelsProtoP\001ZHazimuth/gen/protos/go/sift/calculated_channels/v2;calculatedchannelsv2pb\242\002\003SCX\252\002\032Sift.CalculatedChannels.V2\312\002\032Sift\\CalculatedChannels\\V2\342\002&Sift\\CalculatedChannels\\V2\\GPBMetadata\352\002\034Sift::CalculatedChannels::V2'
  ...
  _globals['_CALCULATEDCHANNEL'].fields_by_name['calculated_channel_dependencies']._loaded_options = None
  _globals['_CALCULATEDCHANNEL'].fields_by_name['calculated_channel_dependencies']._serialized_options = b'\340A\002'
  ...
  _globals['_CALCULATEDCHANNELABSTRACTCHANNELREFERENCE'].fields_by_name['channel_identifier']._serialized_options = b'\340A\001'
  ...
  _globals['_GETCALCULATEDCHANNELREQUEST'].fields_by_name['calculated_channel_version_id']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELREQUEST'].fields_by_name['calculated_channel_version_id']._serialized_options = b'\340A\001'
  ...
  _globals['_GETCALCULATEDCHANNELVERSIONSREQUEST'].fields_by_name['calculated_channel_version_ids']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELVERSIONSREQUEST'].fields_by_name['calculated_channel_version_ids']._serialized_options = b'\340A\002'
  _globals['_GETCALCULATEDCHANNELVERSIONSRESPONSE'].fields_by_name['calculated_channels']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELVERSIONSRESPONSE'].fields_by_name['calculated_channels']._serialized_options = b'\340A\002'
  _globals['_GETCALCULATEDCHANNELDEPENDENTSREQUEST'].fields_by_name['calculated_channel_id']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELDEPENDENTSREQUEST'].fields_by_name['calculated_channel_id']._serialized_options = b'\340A\001'
  _globals['_GETCALCULATEDCHANNELDEPENDENTSREQUEST'].fields_by_name['calculated_channel_version_id']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELDEPENDENTSREQUEST'].fields_by_name['calculated_channel_version_id']._serialized_options = b'\340A\001'
  _globals['_GETCALCULATEDCHANNELDEPENDENTSRESPONSE'].fields_by_name['calculated_channels']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELDEPENDENTSRESPONSE'].fields_by_name['calculated_channels']._serialized_options = b'\340A\002'
  _globals['_GETCALCULATEDCHANNELDEPENDENTSRESPONSE'].fields_by_name['rules']._loaded_options = None
  _globals['_GETCALCULATEDCHANNELDEPENDENTSRESPONSE'].fields_by_name['rules']._serialized_options = b'\340A\002'
  ...
  _globals['_CALCULATEDCHANNELSERVICE'].methods_by_name['GetCalculatedChannelVersions']._loaded_options = None
  _globals['_CALCULATEDCHANNELSERVICE'].methods_by_name['GetCalculatedChannelVersions']._serialized_options = b'\222AZ\022\034GetCalculatedChannelVersions\032:Retrieve calculated channel versions by their version IDs.\202\323\344\223\002&\022$/api/v2/calculated-channels/versions'
