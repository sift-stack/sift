...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ASSET'].fields_by_name['metadata']._serialized_options = b'\340A\002'
  _globals['_ASSET'].fields_by_name['archived_date']._loaded_options = None
  _globals['_ASSET'].fields_by_name['archived_date']._serialized_options = b'\340A\001'
  _globals['_ASSET'].fields_by_name['is_archived']._loaded_options = None
  _globals['_ASSET'].fields_by_name['is_archived']._serialized_options = b'\340A\002'
  ...
  _globals['_ARCHIVEASSETREQUEST'].fields_by_name['asset_id']._loaded_options = None
  _globals['_ARCHIVEASSETREQUEST'].fields_by_name['asset_id']._serialized_options = b'\340A\002'
  _globals['_ARCHIVEASSETREQUEST'].fields_by_name['archive_runs']._loaded_options = None
  _globals['_ARCHIVEASSETREQUEST'].fields_by_name['archive_runs']._serialized_options = b'\340A\001'
  _globals['_ARCHIVEASSETRESPONSE'].fields_by_name['archived_run_ids']._loaded_options = None
  _globals['_ARCHIVEASSETRESPONSE'].fields_by_name['archived_run_ids']._serialized_options = b'\340A\001'
  ...
  _globals['_ASSETSERVICE'].methods_by_name['ArchiveAsset']._loaded_options = None
  _globals['_ASSETSERVICE'].methods_by_name['ArchiveAsset']._serialized_options = b'\222A\"\022\014ArchiveAsset\032\022Archives an asset.\202\323\344\223\002#\"!/api/v1/assets/{asset_id}/archive'
  _globals['_ASSET']._serialized_start=259
  _globals['_ASSET']._serialized_end=808
  _globals['_LISTASSETSREQUEST']._serialized_start=811
  _globals['_LISTASSETSREQUEST']._serialized_end=961
  _globals['_LISTASSETSRESPONSE']._serialized_start=963
  _globals['_LISTASSETSRESPONSE']._serialized_end=1070
  _globals['_DELETEASSETREQUEST']._serialized_start=1072
