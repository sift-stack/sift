...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\025com.sift.campaigns.v1B\016CampaignsProtoP\001Z5azimuth/gen/protos/go/sift/campaigns/v1;campaignsv1pb\242\002\003SCX\252\002\021Sift.Campaigns.V1\312\002\021Sift\\Campaigns\\V1\342\002\035Sift\\Campaigns\\V1\\GPBMetadata\352\002\023Sift::Campaigns::V1\222A\024\022\022\n\020Campaign service'
  ...
  _globals['_CAMPAIGN'].fields_by_name['metadata']._loaded_options = None
  _globals['_CAMPAIGN'].fields_by_name['metadata']._serialized_options = b'\340A\001'
  _globals['_CAMPAIGN'].fields_by_name['is_archived']._loaded_options = None
  _globals['_CAMPAIGN'].fields_by_name['is_archived']._serialized_options = b'\340A\002'
  _globals['_CAMPAIGN'].fields_by_name['reports_include_summaries']._loaded_options = None
  _globals['_CAMPAIGN'].fields_by_name['reports_include_summaries']._serialized_options = b'\340A\003'
  ...
  _globals['_GETCAMPAIGNREQUEST'].fields_by_name['skip_report_summaries']._loaded_options = None
  _globals['_GETCAMPAIGNREQUEST'].fields_by_name['skip_report_summaries']._serialized_options = b'\340A\001'
  ...
  _globals['_CREATECAMPAIGNREQUEST'].fields_by_name['metadata']._loaded_options = None
  _globals['_CREATECAMPAIGNREQUEST'].fields_by_name['metadata']._serialized_options = b'\340A\001'
  ...
  _globals['_LISTCAMPAIGNSREQUEST'].fields_by_name['skip_report_summaries']._loaded_options = None
  _globals['_LISTCAMPAIGNSREQUEST'].fields_by_name['skip_report_summaries']._serialized_options = b'\340A\001'
  ...
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['campaign_id']._loaded_options = None
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['campaign_id']._serialized_options = b'\340A\002'
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\001'
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['order_by']._loaded_options = None
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST'].fields_by_name['order_by']._serialized_options = b'\340A\001'
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST'].fields_by_name['campaign_ids']._loaded_options = None
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST'].fields_by_name['campaign_ids']._serialized_options = b'\340A\002'
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST'].fields_by_name['organization_id']._loaded_options = None
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST'].fields_by_name['organization_id']._serialized_options = b'\340A\001'
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE_SUMMARIESBYCAMPAIGNIDENTRY']._loaded_options = None
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE_SUMMARIESBYCAMPAIGNIDENTRY']._serialized_options = b'8\001'
  ...
  _globals['_CAMPAIGNSERVICE'].methods_by_name['ListCampaignAnnotations']._loaded_options = None
  _globals['_CAMPAIGNSERVICE'].methods_by_name['ListCampaignAnnotations']._serialized_options = b'\222A;\022\027ListCampaignAnnotations\032 List annotations for a campaign.\202\323\344\223\002-\022+/api/v1/campaigns/{campaign_id}/annotations'
  _globals['_CAMPAIGNSERVICE'].methods_by_name['GetCampaignReportSummaries']._loaded_options = None
  _globals['_CAMPAIGNSERVICE'].methods_by_name['GetCampaignReportSummaries']._serialized_options = b'\222AL\022\032GetCampaignReportSummaries\032.Returns per-campaign report summaries in bulk.\202\323\344\223\002\'\"\"/api/v1/campaigns:report-summaries:\001*'
  _globals['_CAMPAIGN']._serialized_start=379
  _globals['_CAMPAIGN']._serialized_end=1302
  _globals['_CAMPAIGNREPORT']._serialized_start=1305
  _globals['_CAMPAIGNREPORT']._serialized_end=1627
  _globals['_GETCAMPAIGNREQUEST']._serialized_start=1630
  _globals['_GETCAMPAIGNREQUEST']._serialized_end=1827
  _globals['_GETCAMPAIGNRESPONSE']._serialized_start=1829
  _globals['_GETCAMPAIGNRESPONSE']._serialized_end=1912
  _globals['_CREATECAMPAIGNREQUEST']._serialized_start=1915
  _globals['_CREATECAMPAIGNREQUEST']._serialized_end=2330
  _globals['_CREATECAMPAIGNFROM']._serialized_start=2333
  _globals['_CREATECAMPAIGNFROM']._serialized_end=2584
  _globals['_CREATECAMPAIGNRESPONSE']._serialized_start=2586
  _globals['_CREATECAMPAIGNRESPONSE']._serialized_end=2672
  _globals['_LISTCAMPAIGNSREQUEST']._serialized_start=2675
  _globals['_LISTCAMPAIGNSREQUEST']._serialized_end=2979
  _globals['_LISTCAMPAIGNSRESPONSE']._serialized_start=2981
  _globals['_LISTCAMPAIGNSRESPONSE']._serialized_end=3103
  _globals['_UPDATECAMPAIGNREQUEST']._serialized_start=3106
  _globals['_UPDATECAMPAIGNREQUEST']._serialized_end=3257
  _globals['_UPDATECAMPAIGNRESPONSE']._serialized_start=3259
  _globals['_UPDATECAMPAIGNRESPONSE']._serialized_end=3345
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST']._serialized_start=3348
  _globals['_LISTCAMPAIGNANNOTATIONSREQUEST']._serialized_end=3549
  _globals['_LISTCAMPAIGNANNOTATIONSRESPONSE']._serialized_start=3552
  _globals['_LISTCAMPAIGNANNOTATIONSRESPONSE']._serialized_end=3692
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST']._serialized_start=3694
  _globals['_GETCAMPAIGNREPORTSUMMARIESREQUEST']._serialized_end=3815
  _globals['_CAMPAIGNREPORTS']._serialized_start=3817
  _globals['_CAMPAIGNREPORTS']._serialized_end=3895
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE']._serialized_start=3898
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE']._serialized_end=4184
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE_SUMMARIESBYCAMPAIGNIDENTRY']._serialized_start=4076
  _globals['_GETCAMPAIGNREPORTSUMMARIESRESPONSE_SUMMARIESBYCAMPAIGNIDENTRY']._serialized_end=4184
  _globals['_CAMPAIGNSERVICE']._serialized_start=4187
  _globals['_CAMPAIGNSERVICE']._serialized_end=5526
