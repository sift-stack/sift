...
class PolicyServiceStub:
    ...
    ValidatePolicy: grpc.UnaryUnaryMultiCallable[
        sift.policies.v1.policies_pb2.ValidatePolicyRequest,
        sift.policies.v1.policies_pb2.ValidatePolicyResponse,
    ]
    ...
    UnarchivePolicy: grpc.UnaryUnaryMultiCallable[
        sift.policies.v1.policies_pb2.UnarchivePolicyRequest,
        sift.policies.v1.policies_pb2.UnarchivePolicyResponse,
    ]
    """Unarchive a policy"""
...
class PolicyServiceAsyncStub:
    ...
    ValidatePolicy: grpc.aio.UnaryUnaryMultiCallable[
        sift.policies.v1.policies_pb2.ValidatePolicyRequest,
        sift.policies.v1.policies_pb2.ValidatePolicyResponse,
    ]
    """Validate a Cedar policy configuration"""
    ...
    UnarchivePolicy: grpc.aio.UnaryUnaryMultiCallable[
        sift.policies.v1.policies_pb2.UnarchivePolicyRequest,
        sift.policies.v1.policies_pb2.UnarchivePolicyResponse,
    ]
    """Unarchive a policy"""
...
class PolicyServiceServicer(metaclass=abc.ABCMeta):
    ...
    def ValidatePolicy(
        self,
        request: sift.policies.v1.policies_pb2.ValidatePolicyRequest,
        context: _ServicerContext,
    ) -> typing.Union[sift.policies.v1.policies_pb2.ValidatePolicyResponse, collections.abc.Awaitable[sift.policies.v1.policies_pb2.ValidatePolicyResponse]]:
        """Validate a Cedar policy configuration"""
    ...
    def UnarchivePolicy(
        self,
        request: sift.policies.v1.policies_pb2.UnarchivePolicyRequest,
        context: _ServicerContext,
    ) -> typing.Union[sift.policies.v1.policies_pb2.UnarchivePolicyResponse, collections.abc.Awaitable[sift.policies.v1.policies_pb2.UnarchivePolicyResponse]]:
        """Unarchive a policy"""
