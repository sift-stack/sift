...
@typing.final
class ValidatePolicyRequest(google.protobuf.message.Message):
...
global___ValidatePolicyRequest = ValidatePolicyRequest

@typing.final
class ValidatePolicyResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_failure_message", b"_failure_message", "failure_message", b"failure_message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_failure_message", b"_failure_message", "failure_message", b"failure_message", "valid", b"valid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_failure_message", b"_failure_message"]) -> typing.Literal["failure_message"] | None: ...

global___ValidatePolicyResponse = ValidatePolicyResponse
...
@typing.final
class UnarchivePolicyRequest(google.protobuf.message.Message):
...
global___UnarchivePolicyRequest = UnarchivePolicyRequest

@typing.final
class UnarchivePolicyResponse(google.protobuf.message.Message):
...
global___UnarchivePolicyResponse = UnarchivePolicyResponse
