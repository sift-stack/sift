...
class DataServiceStub:
    ...
    GetData: grpc.UnaryUnaryMultiCallable[
        sift.data.v2.data_pb2.GetDataRequest,
        sift.data.v2.data_pb2.GetDataResponse,
    ]
    """Query data"""
...
class DataServiceServicer(metaclass=abc.ABCMeta):
    ...
    def GetData(
        self,
        request: sift.data.v2.data_pb2.GetDataRequest,
        context: _ServicerContext,
    ) -> typing.Union[sift.data.v2.data_pb2.GetDataResponse, collections.abc.Awaitable[sift.data.v2.data_pb2.GetDataResponse]]:
        """Query data"""
