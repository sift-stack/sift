...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_INGESTIONCONFIGSERVICE'].methods_by_name['CreateIngestionConfigFlows']._serialized_options = b'\222A<\022\032CreateIngestionConfigFlows\032\036Create ingestion config flows.\202\323\344\223\002:\"5/api/v1/ingestion-configs/{ingestion_config_id}/flows:\001*'
  _globals['_INGESTIONCONFIGSERVICE'].methods_by_name['ListIngestionConfigFlows']._loaded_options = None
  _globals['_INGESTIONCONFIGSERVICE'].methods_by_name['ListIngestionConfigFlows']._serialized_options = b'\222AQ\022\030ListIngestionConfigFlows\0325List ingestion config flows using an optional filter.\202\323\344\223\0027\0225/api/v1/ingestion-configs/{ingestion_config_id}/flows'
  ...
  _globals['_INGESTIONCONFIGSERVICE']._serialized_end=3827
