...
def create_authenticated_connection(url, token_type, token_value):
    header_adder_interceptor_instance = header_adder_interceptor(
        token_type, token_value)

    channel = grpc.secure_channel(url, grpc.ssl_channel_credentials())
    return grpc.intercept_channel(channel, header_adder_interceptor_instance)
